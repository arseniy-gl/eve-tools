...
case class GetFwLeaderboardsCorporationsVictoryPoints (
  ...
  activeTotal: List[GetFwLeaderboardsCorporationsActiveTotal1],
  /* Top 10 ranking of corporations by victory points in the past week */
  lastWeek: List[GetFwLeaderboardsCorporationsLastWeek1],
