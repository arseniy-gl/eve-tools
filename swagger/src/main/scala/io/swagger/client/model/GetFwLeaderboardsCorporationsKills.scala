...
case class GetFwLeaderboardsCorporationsKills (
  ...
  activeTotal: List[GetFwLeaderboardsCorporationsActiveTotal],
  /* Top 10 ranking of corporations by kills in the past week */
  lastWeek: List[GetFwLeaderboardsCorporationsLastWeek],
