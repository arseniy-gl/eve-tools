...
class LoyaltyApi(val defBasePath: String = "https://esi.tech.ccp.is/latest",
   ...
   */
  def getCharactersCharacterIdLoyaltyPoints(characterId: Int, datasource: Option[String] /* = tranquility*/, token: Option[String] = None, userAgent: Option[String] = None, xUserAgent: Option[String] = None): Option[List[GetCharactersCharacterIdLoyaltyPoints200Ok]] = {
    // create path and map variables
    val path = "/characters/{character_id}/loyalty/points/".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "character_id" + "\\}",apiInvoker.escape(characterId))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(apiInvoker.deserialize(s, "array", classOf[GetCharactersCharacterIdLoyaltyPoints200Ok]).asInstanceOf[List[GetCharactersCharacterIdLoyaltyPoints200Ok]])
        case _ => None
      }
    } catch {
   ...
   */
  def getLoyaltyStoresCorporationIdOffers(corporationId: Int, datasource: Option[String] /* = tranquility*/, userAgent: Option[String] = None, xUserAgent: Option[String] = None): Option[List[GetLoyaltyStoresCorporationIdOffers200Ok]] = {
    // create path and map variables
    val path = "/loyalty/stores/{corporation_id}/offers/".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "corporation_id" + "\\}",apiInvoker.escape(corporationId))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(apiInvoker.deserialize(s, "array", classOf[GetLoyaltyStoresCorporationIdOffers200Ok]).asInstanceOf[List[GetLoyaltyStoresCorporationIdOffers200Ok]])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
