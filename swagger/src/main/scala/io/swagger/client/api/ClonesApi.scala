...
class ClonesApi(val defBasePath: String = "https://esi.tech.ccp.is/latest",
   ...
   */
  def getCharactersCharacterIdClones(characterId: Int, datasource: Option[String] /* = tranquility*/, token: Option[String] = None, userAgent: Option[String] = None, xUserAgent: Option[String] = None): Option[GetCharactersCharacterIdClonesOk] = {
    // create path and map variables
    val path = "/characters/{character_id}/clones/".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "character_id" + "\\}",apiInvoker.escape(characterId))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(apiInvoker.deserialize(s, "", classOf[GetCharactersCharacterIdClonesOk]).asInstanceOf[GetCharactersCharacterIdClonesOk])
        case _ => None
      }
    } catch {
   ...
   * @return List[Int]
   */
  def getCharactersCharacterIdImplants(characterId: Int, datasource: Option[String] /* = tranquility*/, token: Option[String] = None, userAgent: Option[String] = None, xUserAgent: Option[String] = None): Option[List[Int]] = {
    // create path and map variables
    val path = "/characters/{character_id}/implants/".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "character_id" + "\\}",apiInvoker.escape(characterId))
