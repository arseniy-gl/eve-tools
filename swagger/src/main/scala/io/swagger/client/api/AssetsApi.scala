...
class AssetsApi(val defBasePath: String = "https://esi.tech.ccp.is/latest",
   ...
   */
  def getCharactersCharacterIdAssets(characterId: Int, datasource: Option[String] /* = tranquility*/, token: Option[String] = None, userAgent: Option[String] = None, xUserAgent: Option[String] = None): Option[List[GetCharactersCharacterIdAssets200Ok]] = {
    // create path and map variables
    val path = "/characters/{character_id}/assets/".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "character_id" + "\\}",apiInvoker.escape(characterId))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(apiInvoker.deserialize(s, "array", classOf[GetCharactersCharacterIdAssets200Ok]).asInstanceOf[List[GetCharactersCharacterIdAssets200Ok]])
        case _ => None
      }
    } catch {
