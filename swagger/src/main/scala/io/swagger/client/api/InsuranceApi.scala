...
class InsuranceApi(val defBasePath: String = "https://esi.tech.ccp.is/latest",
   ...
   */
  def getInsurancePrices(datasource: Option[String] /* = tranquility*/, language: Option[String] /* = en-us*/, userAgent: Option[String] = None, xUserAgent: Option[String] = None): Option[List[GetInsurancePrices200Ok]] = {
    // create path and map variables
    val path = "/insurance/prices/".replaceAll("\\{format\\}", "json")
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(apiInvoker.deserialize(s, "array", classOf[GetInsurancePrices200Ok]).asInstanceOf[List[GetInsurancePrices200Ok]])
        case _ => None
      }
    } catch {
